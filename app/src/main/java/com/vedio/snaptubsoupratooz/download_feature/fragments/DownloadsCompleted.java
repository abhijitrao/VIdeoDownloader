...
import com.vedio.snaptubsoupratooz.download_feature.VideoThumbDownloader;
import com.vedio.snaptubsoupratooz.download_feature.lists.CompletedVideos;
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if (i == R.id.download_delete) {
                                ...
                                Uri fileUri = FileProvider.getUriForFile(getActivity(), "com.vedio.snaptubsoupratooz.fileprovider", file);
